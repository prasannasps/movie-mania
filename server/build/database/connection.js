...
var DatabaseConnection = /** @class */ (function () {
    ...
    DatabaseConnection.prototype.testConnection = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.clientDemo()];
                    case 1:
    ...
    DatabaseConnection.prototype.clientDemo = function () {
        return __awaiter(this, void 0, void 0, function () {
            var client, now;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        client = new pg_1.Client(this.credentials);
    ...
    DatabaseConnection.prototype.dbConnection = function (query, values) {
        return __awaiter(this, void 0, void 0, function () {
            var client, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
