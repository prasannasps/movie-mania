...
var GenreController = /** @class */ (function (_super) {
    __extends(GenreController, _super);
    function GenreController() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    GenreController.prototype.fetchAllGenres = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var query, result, genres, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        query = 'SELECT * from s_movie_mania.genres';
